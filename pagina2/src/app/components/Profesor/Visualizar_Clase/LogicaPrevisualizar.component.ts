...
@Component({
    selector: 'app-LogicaPrevisualizar',
    templateUrl: './LogicaPrevisualizar.component.html',
    styleUrls: ['./PrevisualizarClase.component.scss', '../FondoP.component.scss','../Denuncias/Denuncias.component.scss']
  })
  export class  LogicaPrevisualizarClaseComponent{
    form!: FormGroup;
    ...
    nav_verclase(clase:string){
      ...
      this.router.navigate([`/profesor/${this.idProfesor}/ver-clase-logica`]);
    }

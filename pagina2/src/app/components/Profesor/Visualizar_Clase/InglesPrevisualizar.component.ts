...
@Component({
    selector: 'app-InglesPrevisualizar',
    templateUrl: './InglesPrevisualizar.component.html',
    styleUrls: ['./PrevisualizarClase.component.scss', '../FondoP.component.scss','../Denuncias/Denuncias.component.scss']
  })
  export class  InglesPrevisualizarClaseComponent{
    form!: FormGroup;
    ...
    nav_verclase(clase:string){
      ...
      this.router.navigate([`/profesor/${this.idProfesor}/ver-clase-ingles`]);
    }

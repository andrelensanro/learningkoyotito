...
@Component({
  selector:  'app-CienciasPrevisualizar',
  templateUrl: './CienciasPrevisualizar.component.html',
    styleUrls: ['./PrevisualizarClase.component.scss', '../FondoP.component.scss','../Denuncias/Denuncias.component.scss']
  })
  export class  CienciasPrevisualizarClaseComponent{
    form!: FormGroup;
    ...
    nav_verclase(clase:string){
      ...
      this.router.navigate([`/profesor/${this.idProfesor}/ver-clase-ciencias`]);
    }

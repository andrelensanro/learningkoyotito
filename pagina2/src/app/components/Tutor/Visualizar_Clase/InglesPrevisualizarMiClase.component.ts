...
@Component({
    selector: 'app-InglesPrevisualizarMiClase',
    templateUrl: './InglesPrevisualizarMiClase.component.html',
    styleUrls: ['./PrevisualizarMiClase.component.scss', '../FondoP.component.scss','../Denuncias/Denuncias.component.scss']
  })
  export class  InglesPrevisualizarMiClaseComponent{
    form!: FormGroup;

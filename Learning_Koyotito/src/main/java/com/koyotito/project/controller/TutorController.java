...
public class TutorController {
	...
	@GetMapping("/{idTutor}/consultar")
	public Tutor consultarTutor(@PathVariable("idTutor") Long idTutor) {
		return tutorService.findById(idTutor);
	}
	
	@GetMapping("/consultar-tutorados/{idTutor}")
	public List<Tutorado> consultarTutorados(@PathVariable("idTutor") Long idTutor){

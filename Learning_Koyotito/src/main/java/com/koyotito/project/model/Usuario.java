...
public class Usuario {
	...
	@JoinColumn(name = "admin_id", referencedColumnName = "idAdministrador",  nullable = true)
	private Administrador administrador;

	@OneToOne(cascade = CascadeType.PERSIST)
	@JoinColumn(name = "tutor_id", referencedColumnName = "idTutor",  nullable = true)
	private Tutor tutor;

	@OneToOne(cascade = CascadeType.PERSIST)
	@JoinColumn(name = "prof_id", referencedColumnName = "idProfesor", nullable = true)
	...
	public Usuario(Long idUsuario, String nombre, String apellido1, String apellido2, String correo, String password,
			Integer num_denuncias, Integer idTipoUsuario, Administrador administrador, Tutor tutor, Profesor profesor,  String instPseudonimo) {
		super();
	...
	public String toString() {
		return "Usuario [idUsuario=" + idUsuario + ", nombre=" + nombre + ", apellido=" + apellido1 + ", apellido2="
				...
				+ ", idTipoUsuario=" + idTipoUsuario +  "administrador=" + administrador + ", tutor=" + tutor

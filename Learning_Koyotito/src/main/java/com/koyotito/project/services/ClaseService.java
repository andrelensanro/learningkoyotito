...
public class ClaseService {
	...
	public Clase findByNombreClase(String nombre) {
		Optional<Clase> opt = claseRepo.findByNombreClase(nombre);
		if(opt != null)
			return opt.get();
		return null;
	}
	public Long getNumVisitas(Long idClase) {
		return claseRepo.getNumVisitas(idClase);
	}
}
